...
Step 6:Create bands for variables that will be used in the model (Humidity9amCat, Humidity3pmCat,
and WindGustSpeedCat)<br/>
Step 7:Define a function to calculate probability distributions, which go into the Bayesian
Belief Network (BBN)<br/>
Step 8:Create BbnNode objects for Humidity9amCat, Humidity3pmCat, WindGustSpeedCat, and RainTomorrow,
using the probs() function to calculate their probabilities<br/>
...
![Screenshot 2024-09-02 182117](https://github.com/user-attachments/assets/3b4e064c-c61c-4342-bec1-e3e1f661f496)

![image](https://github.com/user-attachments/assets/0581a669-f438-4e7c-8c07-49da52e19172)
